public class HW07_4111064232_1 extends LSD{
    public static void main(String[] args)
    {
        HW07_4111064232_1 test = new HW07_4111064232_1();
        int[][] input = {{0, 1}, {0, 2}, {0, 4}, {1, 3}, {1, 4}, {2, 5}, {6, 7}};
        System.out.printf("%d", test.distance(input));
    }
