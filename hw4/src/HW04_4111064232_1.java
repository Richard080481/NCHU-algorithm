public class HW04_4111064232_1 extends LanguageModel
{
    ...
    {
        HW04_4111064232_1 test = new HW04_4111064232_1();
        String[] test_input = {"臺中市", "臺中市 中華民國 直轄市 中臺灣 臺中市 中華民國 臺灣"};
        String[] test_input2 = {"柯文哲", "柯文哲 外科 醫師 政治人物 柯文哲 民眾黨 主席 柯文哲 民眾黨"};
        System.out.println(test.nextPredictToken(test_input));
        System.out.println(test.nextPredictToken(test_input2));
    }
}